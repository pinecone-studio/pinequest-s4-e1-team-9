-- Server-side ingestion uses the Supabase service role through PostgREST.
...
-- GoogleGenerativeAIEmbeddings returns 768-dimensional vectors for the
-- embedding models used by this backend.
